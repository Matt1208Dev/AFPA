<?php include ('header.php'); ?>
        ...
        <div class="row">
            <img src="../cour bibliotheque de fonctions/src/img/promotion.jpg" alt="banniere promotionnelle sur les lames de terrasse" title="banniere promotionnelle sur les lames de terrasse">
        </div>
